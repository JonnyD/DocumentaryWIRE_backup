...
namespace DW\DocumentaryBundle\Fixture;
...
class DocumentaryFixtures extends AbstractFixture implements DependentFixtureInterface, ContainerAwareInterface
{
    private $container;
    private $manager;
...
Some people got this idea that things will stop, things will end in catastrophe, but actually none of the philosophies assign that. The agenda seems to be trying to put negative spin on it, to radiate fear out on the planet as opposed to love.",
    ...
    {
        return [
            'DW\DWBundle\DataFixtures\ORM\CategoryFixtures'
        ];
    }
    ...
    {
        return $this->container->get('documentary_wire.documentary_manager');
    }
