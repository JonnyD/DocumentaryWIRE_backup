...
namespace DW\DocumentaryBundle\Repository\Cached;
...
use DW\BaseBundle\Cache\DocumentariesCache;
use DW\BaseBundle\Cache\DocumentaryCache;
use DW\BaseBundle\Cache\CategoryDocumentariesCache;
use DW\DocumentaryBundle\Repository\DocumentaryRepository as DocumentaryRepositoryInterface;
use DW\DocumentaryBundle\Repository\Doctrine\ORM\DocumentaryRepository as DocumentaryRepositoryDoctrine;
...
class DocumentaryRepository implements DocumentaryRepositoryInterface
{
    ...
    {
        $this->documentaryRepository->merge($entity);
    }
