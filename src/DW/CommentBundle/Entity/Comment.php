...
/**
 * @ORM\Entity(repositoryClass="DW\CommentBundle\Repository\Doctrine\ORM\CommentRepository")
...
class Comment
{
    ...
    /**
     * @var ArrayCollection|Comment[] $children
     *
     ...
     *
     * @JMS\Expose
     * @JMS\Type("DW\UserBundle\Entity\User")
     *
	 * @ORM\ManyToOne(targetEntity="DW\UserBundle\Entity\User", inversedBy="comments", cascade="persist", fetch="EAGER")
     ...
     *
     * @JMS\Expose
     * @JMS\Type("DW\DocumentaryBundle\Entity\Documentary")
     *
	 * @ORM\ManyToOne(targetEntity="DW\DocumentaryBundle\Entity\Documentary", inversedBy="comments", cascade="persist")
    ...
    public function addChild(Comment $comment)
    {
        if (!$this->hasChild($comment)) {
            ...
            $comment->setParent($this); //todo: neccessary?
        }
    }
    ...
    public function setDocumentary(Documentary $documentary = null)
    {
        if ($this->documentary == null) {
            ...
            $documentary->addComment($this); //todo
        }
    }
