...
use DW\UserBundle\Form\ChangePasswordForm;
use DW\UserBundle\Form\ChangeUsernameForm;
use DW\UserBundle\Form\UploadAvatarForm;
...
class UserController extends Controller
{
    public function showActivityAction($username, Request $request)
    {
        ...
        $activity = $activityService->getActivityByUser($user);
    ...
    {
        $userManager = $this->getUserService();
    ...
    public function forgotPasswordAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            $userService = $this->getUserService();
            $user = $userService->getUserByUsernameEmail($usernameOrEmail);
            if ($user == null) {
            ...
            if ($form->isValid()) {
                ...
                $userService->mergeAndPersist($user);
...
To reset your password, visit the following address: " . $url);
    ...
    public function resetPasswordAction(Request $request)
    {
        ...
        $userService = $this->getUserService();
        $user = $userService->getUserByResetKey($key);
        if ($user == null) {
    ...
    {
        return $this->container->get(UserServices::USER);
    }
